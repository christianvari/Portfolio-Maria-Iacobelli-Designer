...
exports.createSchemaCustomization = async ({ actions }) => {
  ...
  `);
    ...
    actions.createTypes(/* GraphQL */ `
        ...
        type kontent_item_homepage_benefit implements Node & HomepageBenefit @dontInfer {
            id: ID!
            heading: String @proxy(from: "elements.heading.value")
            text: String @proxy(from: "elements.text.value")
            image: HomepageImage @KontentImage
        ...
        type kontent_item_homepage_product implements Node & HomepageProduct @dontInfer {
            heading: String @proxy(from: "elements.heading.value")
            text: String @proxy(from: "elements.text.value")
            image: HomepageImage @KontentImage
            links: [HomepageLink]
    ...
    actions.createTypes(/* GraphQL */ `
        ...
        type kontent_item_layoutfooter implements Node & LayoutFooter @dontInfer {
            ...
            socialLinks: [SocialLink]
                @KontentNodesFromElement(variableName: "social_links", type: "sociallink")
    ...
    actions.createTypes(
        `
        interface Home implements Node {
            id: ID!
            description: String
            greetings: String
            hero: String
        ...
        type kontent_item_home implements Node & Home @dontInfer {
            id: ID!
            description: String @proxy(from: "elements.description.value")
            subdescription: String @proxy(from: "elements.subdescription.value")
